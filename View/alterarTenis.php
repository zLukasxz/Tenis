...
<div class="row g-3 align-items-center">
    <div class="col-auto">
        <label for="inputCodigo" class="col-form-label">Digite o nome do Tênis</label>
    </div>
    <div class="col-auto">
...
<table class="table table-hover">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><?php echo($tenis["nomeTenis"])?></td>
      ...
      <td><a class="btn btn-primary" href="alterarFormulario.php?idTenis=<?=$tenis["idTenis"]?>">Alterar</a></td>
      <style>
          th,td{
